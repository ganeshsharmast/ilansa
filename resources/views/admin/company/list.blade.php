                      ...
                      <table class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="{{url('admin/company/edit/'.$company['id'])}}"><i class="mdi mdi-pencil" title="Edit"></i></a>,
                                <a href="{{url('admin/company/view/'.$company['id'])}}"><i class="mdi mdi-eye-outline" title="View"></i></a>,
                                <a href="#" id="company_delete" data-id="{{$company['id']}}"><i class="mdi mdi-delete-outline" title="Delete"></i></a>
                            </td>
                          </tr>
                          @endforeach
                          @else
